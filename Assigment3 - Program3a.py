...
2. the quantity of even and odd numbers inputed by user.
"""
...
print("\nThe quantity of even numbers typed is {0} and the quantity of odd numbers typed is {1}.".format(numOfEven, numOfOdd))
print("")